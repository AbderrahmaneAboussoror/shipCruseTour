        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item me-3">
                <a class="nav-link" href="search">Find & Book</a>
              </li>
...
<section class="text-center overflow-hidden">
    <!-- Background image -->
    <div class="p-5 bg-image img-fluid" style="
          background-image: url('./public/images/joseph-barrientos-oQl0eVYd_n8-unsplash.jpg');
    ...
    <div class="row d-flex flex-column align-items-center">
        <div class="card mx-4 mx-md-5 shadow-5-strong w-50" style="
          margin-top: -100px;
          ...
          ">
            <div class="card-body py-5 px-md-5">
                ...
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-5">Hello, Glad to see you again! <i class="fa fa-hand-peace-o"></i></h2>
                    <form method="post">
                    ...
                    <!-- Submit button -->
                    <button type="submit" name="submit" class="btn btn-primary btn-block mb-4 w-25">
                        Sign in
                    </button>
